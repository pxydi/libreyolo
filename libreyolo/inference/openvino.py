...
class LIBREYOLOOpenVINO:
    ...
    Provides the same API as LIBREYOLOX/LIBREYOLO9 but uses OpenVINO
    ...
    def __init__(self, model_dir: str, nb_classes: int = None, device: str = "auto"):
        ...
        # Read expected input size from model (fallback to metadata or 640)
    ...
    def _read_metadata(self, metadata_path: Path, nb_classes_override: int = None) -> None:
        ...
        # nb_classes: explicit arg > metadata > 80
    ...
    def _predict_single(
        ...
        all_outputs = [result[output] for output in self.compiled_model.outputs]
    ...
    def _parse_outputs(
        ...
        """Parse OpenVINO outputs into (boxes_xyxy, scores, class_ids) based on model family."""
